...
const LoginComponent = () => {
  ...
  useEffect(() => {
    ...
    if (isAuthenticated) {
      ...
      if (
        user.loggedinType === "normal" ||
        user.loggedinType === "normal-verify"
      ) {
        navigate("/dashboard");
      }
    }
  ...
  return (
    <div className="mc mc-login">
      <div className="min-h-screen relative bg-gray-300 border flex items-center bg-login-img">
        <div
          className={`parnt-login-h-438 absolute mc-child main-bg-color transition-all duration-500 flex ${
            isClosed ? "w-[376px]" : "w-[752px]"
          }`}
        >
          {/* The Toggle Button */}
          <button
          ...
          <div
            className={`child-login-h-438 bg-white shadow-lg max-w-sm transition-all duration-500 ${
              isClosed ? "max-w-full" : "max-w-[50%]"
            } overflow-hidden`}
          >
            <div className="pt-8 pl-8 pr-8">
              <div>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  {!showEmailInput && !showOtpInput ? ( // Hide login form if OTP input is shown
                    <>
                      ...
                      <div className="flex justify-center mb-4">
                        <img
                          className="login-logo-img text-center"
                          src={echttechlogo}
                          alt=""
                        />
                      </div>
                      ...
                      <div className="pb-1">
                        <label
                          htmlFor="email"
                          className="block text-black font-bold text-[14px]"
                        >
                          {t("Email / Emp ID")}
                        </label>
                        <input
                      ...
                      <div className="pb-1 relative ">
                        ...
                        {errors.password && (
                          <p className="text-red-500 text-xs error-message">
                          ...
                          <input
                            ...
                            {...register("captcha", {
                              ...
                              minLength: {
                                value: 6,
                                message:
                                  "captcha must be at least 6 characters long.",
                              },
                              pattern: {
                                value: /^[a-zA-Z0-9]{6}$/,
                      ...
                      <div className="flex items-center">
                        <button className="text-sm signin-text font-bold w-1/2 mt-3 border rounded-lg text-wrap text-sm text-black font-bold py-2 px-1 mr-2">
                          Sign In with OTP
                        </button>
                        <button className="text-sm signin-text font-bold w-1/2 mt-3 border rounded-lg text-wrap text-sm text-black font-bold py-2 px-1">
                          Forget Password
                        </button>
                      </div>
                    </>
                  ...
                  {showEmailInput ? (
                    <div className="mb-4">
                      <label htmlFor="forgetEmail" className="sr-only">
                ...
                {!showEmailInput &&
                  !showOtpInput && ( // Show only when OTP input is not shown
              ...
              <form onSubmit={handleSubmitveryfy(onSubmit)}>
                <div className="px-8 pb-20">
                  ...
                  <p className="font-bold mb-2">
                    Verification Code (Sent to registered Email & Mobile)
                  </p>
                  <input
                    type="text"
                    id="sentotp"
                  ...
                  <div className="flex items-center">
                    <button
                      className="login-btn mt-4 bg-gradient-to-r text-white font-bold py-3 px-2 from-blue-300 via-blue-500 to-blue-900 transition duration-300 w-1/2"
                      onClick={() => onButtonClick("otp")}
                    >
                      Resend Code
                    </button>
                    <button
                      className="mt-4 bg-gray-500  text-white font-bold py-3 mx-1 px-4 rounded w-1/2"
                      onClick={() => onButtonClick("normal-verify")}
                    >
                      Verify
                    </button>
                  </div>
          ...
          <div
            className={`main-bg-color flex justify-between overflow-hidden cstm-border-radius shadow-lg transition-all duration-500 ${
              isClosed ? "max-w-0 overflow-hidden" : "max-w-[50%]"
            }`}
          >
            <div className="p-8 log-style flex items-center justify-center">
              <div className="login-style">
                ...
                <h4 className=" text-black font-bold mt-2 mb-1">
                  ...
                  <span className="font-bold">Handle Tasks .</span>
                </h4>
                <p className="text-black">
                  Manage your HR tasks efficiently. See how our innovative
                  works.
                </p>
              </div>
            </div>
