  ...
  return (
    <div>
      <div className="w-full top-section p-4 border rounded-lg bg-white">
        <div className="top-head">
          <div className="flex justify-between pb-3 w-full text-black">
            <h1 className="text-lg font-bold">Add New Contract Type</h1>
          </div>
          <hr className="mb-6" />
          ...
          <div className="department-below-sect w-full">
            <div className="flex flex-col md:flex-row md:space-x-4 justify-between items-center">
              <div className="flex-1 bg-white rounded-lg mb-4">
                <label className="block text-black font-bold">Contract Type</label>
                <input
                  type="text"
              ...
              <div className="add-reset-btns flex items-center pt-4 justify-start">
      ...
      <div className="contract-type-list overflow-auto mx-auto p-6 border rounded-lg bg-white mt-5">
        <h1 className="text-lg font-bold mb-2">List All Contract Type</h1>
        ...
        <table className="min-w-full border border-gray-300">
          <thead>
            <tr className="main-bg-color">
              ...
              <th className="border border-gray-300 px-4 py-2">Contract Type</th>
