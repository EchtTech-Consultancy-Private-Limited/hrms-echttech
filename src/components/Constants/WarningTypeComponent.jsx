    ...
    <div>
      <div className="form-container shadow radius">
        <div className="top-hdr flex justify-between">
          <h1 className="pb-1 font-bold text-xl">Add New Warning Type</h1>
        </div>
        <hr />
      ...
      <div className="contract-type-list mx-auto p-6 border rounded-lg bg-white mt-5">
        <h1 className="text-lg font-bold mb-2">List All Warning Type</h1>
        ...
        <table className="min-w-full border border-gray-300">
          <thead>
            <tr className="main-bg-color">
              ...
              <th className="border border-gray-300 px-4 py-2">Warning Type</th>
              <th className="border border-gray-300 px-4 py-2">Warning Nature</th>
