  ...
  return (
    <div>
        ...
        <div className="w-full top-section p-4 border rounded-lg bg-white">
            ...
            <div className="department-below-sect w-full">
              <div className="flex flex-col md:flex-row md:space-x-1 justify-between">
                <div className="flex-1 bg-white rounded-lg mb-4">
                  <label className="block text-black  font-bold">Name of Template</label>
                  <input
                    type="text"
            ...
            <div className="department-below-sect w-full">
              <div className="flex flex-wrap template-sec">
                <div className="w-full md:w-1/4 bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Basic Salary</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Dearness Allowance</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Overtime(Per hour)</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">House Rent Allowance</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Medical Allowance</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Leave Travel Assistance</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Conveyance Allowance</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Special Allowance</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Statuary Bonus</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Education Allowance</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md"
                    placeholder="0"
          ...
          <div className="total-salary-section ">
            ...
            <div className="department-below-sect w-full">
              <div className="flex flex-wrap template-sec">
                <div className="w-full md:w-1/4 bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Gross Salary</label>
                  <input
                    type="text"
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Totak Allowance + Benefits</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md opacity-40 cursor-not-allowed"
                    placeholder="0" disabled
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Total Deduction</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md opacity-40 cursor-not-allowed"
                    placeholder="0" disabled
                ...
                <div className="w-full md:w-1/4  bg-white rounded-lg mb-4">
                  <label className="block text-black font-bold">Net Salary</label>
                  <input
                    type="text"
                    className="block w-full p-2 border border-gray-300 rounded-md opacity-40 cursor-not-allowed"
                    placeholder="0" disabled
        ...
        <div className='w-full department-list mt-10' >
          <div className='containr dep-list-con mx-auto p-6 border rounded-lg bg-white' >
...
<th className="px-4 border-l main-bg-color border-gray-300 text-center py-3">Payroll Template</th>
...
<th className="px-4 border-l main-bg-color border-gray-300 text-center py-3">Total Allowance</th>
<th className="px-4 border-l main-bg-color border-gray-300 text-center py-3">Created By</th>
<th className="px-4 border-l main-bg-color border-gray-300 text-center py-3">Create Date</th>
...
<td className="py-2 px-4 border-l border-gray-300 text-center">{entry.payrollTemplate}</td>
<td className="py-2 px-4 border-l border-gray-300 text-center">{entry.basicSalary}</td>
<td className="py-2 px-4 border-l border-gray-300 text-center">{entry.netSalary}</td>
<td className="py-2 px-4 border-l border-gray-300 text-center">{entry.totalAllowance}</td>
<td className="py-2 px-4 border-l border-gray-300 text-center">{entry.createdBy}</td>
<td className="py-2 px-4 border-l border-gray-300 text-center">{entry.createDate}</td>
