...
const GeneratePayslipComponent = () => {
  ...
  const data = [
    { id: 1, empName: 'Abhijeet', empId: 'ET111', location: 'Delhi', hourlyRate: 15, type: 'Monthly',   createdBy: 'John', basicsal: '9000',  createdDate: '2023-10-01' , status:'Unpaid' , details:'', salary:"12,000" },
    { id: 2, empName: 'Harwinder', empId: 'ET112', location: 'Delhi', hourlyRate: 20, type: 'Monthly', createdBy: 'Doe', basicsal: '9000',  createdDate: '2023-10-02' , status:'Unpaid' , details:'', salary:"12,000"  },
    { id: 3, empName: 'Anil', empId: 'ET113', location: 'Delhi',hourlyRate: 18, type: 'Monthly', createdBy: 'Alice', basicsal: '9000',  createdDate: '2023-10-03' , status:'Unpaid' , details:'', salary:"12,000" },
    { id: 4, empName: 'Anuj', empId: 'ET114', location: 'Delhi',hourlyRate: 15, type: 'Monthly', createdBy: 'John', basicsal: '9000',  createdDate: '2023-10-01' , status:'Unpaid' , details:'', salary:"12,000"  },
    { id: 5, empName: 'Vikram', empId: 'ET115', location: 'Delhi',hourlyRate: 20, type: 'Monthly', createdBy: 'Doe', basicsal: '9000',  createdDate: '2023-10-02' , status:'Unpaid' , details:'' , salary:"12,000"  },
    { id: 6, empName: 'Shailesh', empId: 'ET116', location: 'Delhi',hourlyRate: 18, type: 'Monthly', createdBy: 'Alice', basicsal: '9000',  createdDate: '2023-10-03' , status:'Unpaid' , details:'' , salary:"12,000"  },
    { id: 7, empName: 'Rohit', empId: 'ET117', location: 'Delhi',hourlyRate: 15, type: 'Monthly', createdBy: 'John', basicsal: '9000',  createdDate: '2023-10-01' , status:'Unpaid' , details:'' , salary:"12,000" },
    { id: 8, empName: 'Vineet', empId: 'ET118', location: 'Delhi',hourlyRate: 20, type: 'Monthly', createdBy: 'Doe', basicsal: '9000',  createdDate: '2023-10-02' , status:'Unpaid' , details:'' , salary:"12,000" },
    { id: 9, empName: 'Sushma', empId: 'ET119', location: 'Delhi',hourlyRate: 18, type: 'Monthly', createdBy: 'Alice', basicsal: '9000',  createdDate: '2023-10-03' , status:'Unpaid' , details:'' , salary:"12,000" },
    { id: 10, empName: 'HariPrasad', empId: 'ET120', location: 'Delhi',hourlyRate: 15, type: 'Monthly', createdBy: 'John', basicsal: '9000',  createdDate: '2023-10-01' , status:'Unpaid' , details:'' ,salary:"12,000" },
    { id: 11, empName: 'Neelu', empId: 'ET121', location: 'Delhi',hourlyRate: 20, type: 'Monthly',createdBy: 'Doe', basicsal: '9000',  createdDate: '2023-10-02' , status:'Unpaid' , details:'' , salary:"12,000" },
    { id: 12, empName: 'Gaurav', empId: 'ET122', location: 'Delhi',hourlyRate: 18, type: 'Monthly', createdBy: 'Alice', basicsal: '9000',  createdDate: '2023-10-03' , status:'Unpaid' , details:'' , salary:"12,000" },
  ];
        ...
        <div className="top-head ">
          ...
          <div className="department-below-sect w-full">
            <div className="flex flex-col md:flex-row md:space-x-1 justify-between">
              ...
              <div className="flex-1 bg-white rounded-lg mb-4">
                <label className="block text-black  font-bold">Select Date Range</label>
                <input
                  type="date"
                  className="block w-full p-2 border border-gray-300 rounded-md"
                />
